...
(root / 'raw/final-cua18-chinese-frame.txt').write_text('\n'.join(screen.display) + '\n')
alt_observed = None
...
result = {'reviewer': 'root', 'candidate_scope': 'round2 frozen TUI, final isolated real PTY sample',
          ...
          'full_termios_restored_except_kernel_PENDIN': True, 'lflag_delta': mode_delta,
...
(root / 'independent-final-pty-review.json').write_text(json.dumps(result, ensure_ascii=False, indent=2) + '\n')
