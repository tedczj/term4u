...
pub struct SerializedBlock {
    ...
    #[serde(default, rename = "ai_metadata")]
    pub removed_feature_metadata: Option<String>,

    /// Whether this block was created locally (true) or remotely (false)
    #[serde(default)]
    pub is_local: Option<bool>,

    #[serde(default, rename = "agent_view_visibility")]
    pub removed_feature_visibility: Option<serde_json::Value>,
}
...
impl From<&Block> for SerializedBlock {
    fn from(block: &Block) -> Self {
        ...
        SerializedBlock {
            ...
            removed_feature_metadata: None,
            is_local: None,
            removed_feature_visibility: None,
        }
    }
}
...
impl From<crate::persistence::model::Block> for SerializedBlock {
    fn from(block: crate::persistence::model::Block) -> Self {
        ...
        Self {
            ...
            removed_feature_metadata: block.ai_metadata,
            is_local: block.is_local,
            removed_feature_visibility: block
