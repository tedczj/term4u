...
impl OrchestrationEventStreamer {
    ...
    fn finish_remote_child_placeholder(
        ...
        result: anyhow::Result<crate::ai::agent_tasks::task::AmbientAgentTask>,
        ctx: &mut ModelContext<Self>,
    ) {
    ...
    fn spawn_task_harness_fetch_if_needed(
        ...
        let Ok(task_id) = run_id.parse::<crate::ai::agent_tasks::AmbientAgentTaskId>() else {
            return;
        };
    ...
    fn finish_restore_fetch(
        ...
        task_id: crate::ai::agent_tasks::AmbientAgentTaskId,
        sqlite_cursor: i64,
        run_result: anyhow::Result<crate::ai::agent_tasks::task::AmbientAgentTask>,
        ctx: &mut ModelContext<Self>,
    ) {
        match run_result {
            Ok(task) => {
    ...
    fn apply_task_children(
        &mut self,
        conversation_id: AIConversationId,
        task: &crate::ai::agent_tasks::task::AmbientAgentTask,
        base_cursor: i64,
    ) {
        let Some(stream) = self.streams.get_mut(&conversation_id) else {
            return;
