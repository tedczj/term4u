        ...
        ctx.spawn_with_retry_on_error_when(
            ...
            move |me,
                ...
                RequestState::RequestSucceeded(secrets) => {
                    ...
                    ctx.emit(HarnessAvailabilityEvent::SecretsLoaded);
                }
                ...
                RequestState::RequestFailed(e) => {
                    ...
                    ctx.emit(HarnessAvailabilityEvent::SecretsFetchFailed);
                }
            },
        );
    }
    ...
    pub fn create_auth_secret(
        ...
        ctx.spawn(create_future, move |me, result, ctx| match result {
            Ok(secret) => {
                ...
                ctx.emit(HarnessAvailabilityEvent::SecretCreated {
                    harness,
                    name: secret.name,
                });
            }
    ...
    pub fn delete_auth_secret(
        ...
        ctx.spawn(delete_future, move |me, result, ctx| match result {
            Ok(()) => {
                ...
                ctx.emit(HarnessAvailabilityEvent::SecretDeleted {
                    harness,
                    name,
                    owner,
                });
            ...
            Err(e) => {
                ...
                ctx.emit(HarnessAvailabilityEvent::SecretDeletionFailed {
                    harness,
                    name,
                    owner,
                    error: msg,
