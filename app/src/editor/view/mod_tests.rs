...
#[test]
fn test_paste_clipboard_with_image_only_keeps_text_empty() {
    App::test((), |mut app| async move {
        initialize_app(&mut app);
...
#[test]
fn test_paste_clipboard_with_png_and_text_pastes_text() {
    App::test((), |mut app| async move {
        initialize_app(&mut app);
...
#[test]
fn test_paste_clipboard_with_bmp_and_text_pastes_text() {
    App::test((), |mut app| async move {
        initialize_app(&mut app);
